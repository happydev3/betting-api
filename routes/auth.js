    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            bcrypt.hash(req.body.password, 10).then((hash) => {
                ...
                let emailString = '<p>Welcome to wifball and thank you for your registration,<br> please confirm your account to discuss football with all the community:<br><br><a href="http://192.162.69.178/wifball/login?verify=' + req.body.email + '">Confimation link</a><br><br>';
